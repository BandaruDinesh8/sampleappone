...
import { ISamplecaptchaParameters } from './samplecaptcha.interface';

// View component input parameters.
const initialComponentProperties: ISamplecaptchaParameters = {
  styles: '',
  hidden: '',
  message: ''
};

export class SamplecaptchaDesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel {
  constructor(protected injector: Injector,
    ...
    combineLatest([this.sandbox.componentProperties$])
      .pipe(
        map(([componentProperties]: [ISamplecaptchaParameters]) =>
  ...
  static getInitialProperties(initialProperties?: ISamplecaptchaParameters): ISamplecaptchaParameters {
  ...
  private setInspectorConfig(model : ISamplecaptchaParameters) {
    return {
  ...
  private validate(
    ...
    model: ISamplecaptchaParameters
