...
import { ISamplestarcomponentParameters } from './samplestarcomponent.interface';

// View component input parameters.
const initialComponentProperties: ISamplestarcomponentParameters = {
  styles: '',
  hidden: '',
  message: ''
};

export class SamplestarcomponentDesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel {
  constructor(protected injector: Injector,
    ...
    combineLatest([this.sandbox.componentProperties$])
      .pipe(
        map(([componentProperties]: [ISamplestarcomponentParameters]) =>
  ...
  static getInitialProperties(initialProperties?: ISamplestarcomponentParameters): ISamplestarcomponentParameters {
  ...
  private setInspectorConfig(model : ISamplestarcomponentParameters) {
    return {
  ...
  private validate(
    ...
    model: ISamplestarcomponentParameters
