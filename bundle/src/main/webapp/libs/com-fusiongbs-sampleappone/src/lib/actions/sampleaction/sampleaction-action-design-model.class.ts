...
export class SampleactionActionDesignModel extends RxViewDesignerActionModel {
  // This method will be called automatically and will set the default values
  // of the input parameters or their current values.
  static getInitialProperties(initialProperties: ViewActionDesignEditableProperties<ISampleactionActionDesignProperties>) {
    return {
      message: '',
      ...initialProperties
    };
  ...
  constructor(protected injector: Injector,
              readonly sandbox: IViewActionDesignSandbox<ISampleactionActionDesignProperties>) {
