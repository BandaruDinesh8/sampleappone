...
import { ISamplefieldcomponentDesignProperties } from './samplefieldcomponent.interfaces';

// A Record Field view component extends BaseRecordEditorFieldDesign.
export class SamplefieldcomponentDesignModel extends BaseRecordEditorFieldDesign {
  ...
  // or configuration.
  componentProperties$: Observable<ISamplefieldcomponentDesignProperties> = this.sandbox.componentProperties$;

  constructor(public injector: Injector, public sandbox: IViewComponentDesignSandbox<ISamplefieldcomponentDesignProperties>) {
    ...
    combineLatest([this.sandbox.componentProperties$])
      .pipe(
        map(([componentProperties]: [ISamplefieldcomponentDesignProperties]) =>
  ...
  static getInitialProperties(initialProperties?: ISamplefieldcomponentDesignProperties): ISamplefieldcomponentDesignProperties {
    return {
  ...
  private validateCustomProperties(
    ...
    model: ISamplefieldcomponentDesignProperties
  ): IViewComponentDesignValidationIssue[] {
