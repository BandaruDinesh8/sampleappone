...
import { ISamplepictureParameters } from './samplepicture.interface';

// View component input parameters.
const initialComponentProperties: ISamplepictureParameters = {
  styles: '',
  hidden: '',
  message: ''
};

export class SamplepictureDesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel {
  constructor(protected injector: Injector,
    ...
    combineLatest([this.sandbox.componentProperties$])
      .pipe(
        map(([componentProperties]: [ISamplepictureParameters]) =>
  ...
  static getInitialProperties(initialProperties?: ISamplepictureParameters): ISamplepictureParameters {
  ...
  private setInspectorConfig(model : ISamplepictureParameters) {
    return {
  ...
  private validate(
    ...
    model: ISamplepictureParameters
